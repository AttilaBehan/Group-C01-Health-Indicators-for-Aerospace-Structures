...
# 4. Functions applied to all input files and downsampled files saved
def run_SPWVD_data_processing(input_dir, output_dir, directory):
    # 1. Input and output file names defined as well as which data columns to use
    csv_files = ["SP\\Sample1Interp.csv", "SP\\Sample1Interp.csv"]
    smoothing_output_filenames = directory / "Output" / ["Sample1_cycle_level_features_smoothed.csv", "Sample1_cycle_level_features_smoothed.csv"]
    windowed_output_filenames = directory / "Output" / ["Sample1_window_level_features_smoothed.csv", "Sample1_window_level_features_smoothed.csv"]
